...
if __name__ == "__main__":
    ...
    settings['core_url'] = 'https://siem.gov74.ru'   #https://maxpatrolsiemaddress
    settings['core_user'] = 'rvision'  #Administrator
    settings['core_pass'] = 'qQ5N8@r>'  #P@ssw0rd
    settings['time_from'] = 600 #in the last 10 minutes
    settings['token'] = '6115624198:AAF4o4Xyx0_H5SS6iv3UoHxtwX_sSCIPeHk'
    settings['chat_id'] = '-783073740'
